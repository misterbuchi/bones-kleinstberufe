...
<?php endif; ?>
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="wrap cf">
					...
					<p id="logo" class="h1" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>" rel="nofollow"><?php  if ( function_exists( 'the_custom_logo' ) ) {
							the_custom_logo();
						} else {
					...
					<nav role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
									<div id="menubox" >									    <input type="checkbox" id="hamburg" class="nav-trigger t-h0 d-h0 m-all" role="tooltip">
									    <label for="hamburg" title="Menu" class="hamburg t-h0 d-h0 m-all">
